...
describe(`🧱 ${FontAwesomeIcon.name}`, () => {
  ...
  test("does render component if icon passed directly", () => {
    ...
    expect(container.querySelector('[data-icon="address-book"]')).not.toBe(
      null,
    );
  });
  ...
  describe("correctly handles properties", () => {
    ...
    describe("`border` property", () => {
      test("false", () => {
        ...
        expect(
          [...container.querySelector("svg").classList].includes("fa-border"),
        ).toBe(false);
      });
      test("true", () => {
    ...
    describe("`fixedWidth` property", () => {
      test("false", () => {
        ...
        expect(
          [...container.querySelector("svg").classList].includes("fa-fw"),
        ).toBe(false);
      });
      test("true", () => {
    ...
    describe("`flip` property", () => {
      ...
      test('"vertical"', () => {
        ...
        expect(
          [...container.querySelector("svg").classList].includes(
            VERTICAL_FLIP_CLASS,
          ),
        ).toBe(true);
      });
      ...
      test('"both"', () => {
        ...
        expect(
          [HORIZONTAL_FLIP_CLASS, VERTICAL_FLIP_CLASS].every((item) =>
            [...container.querySelector("svg").classList].includes(item),
          ),
        ).toBe(true);
      });
      test("null", () => {
    ...
    describe("`listItem` property", () => {
      test("false", () => {
        ...
        expect(
          [...container.querySelector("svg").classList].includes("fa-li"),
        ).toBe(false);
      });
      test("true", () => {
    ...
    describe("`pulse` property", () => {
      test("false", () => {
        ...
        expect(
          [...container.querySelector("svg").classList].includes("fa-pulse"),
        ).toBe(false);
      });
      test("true", () => {
    ...
    describe("`rotation` property", () => {
      const [ROTATE_90_CLASS, ROTATE_180_CLASS, ROTATE_270_CLASS] = [
        90, 180, 270,
    ...
    describe("`size` property", () => {
      ...
      test(NOT_PROVIDED_CASE, () => {
        ...
        expect(
          classes.every((item) => ![...svg.classList].includes(item)),
        ).toBe(true);
      });
    });
